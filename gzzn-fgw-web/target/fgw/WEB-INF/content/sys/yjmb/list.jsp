...
//<!--
	$(document).ready(function() {
		...
		$("#addBtn").click(function(){
			window.location = "${ctx}/sys/yjmb/edit.ac";
		});
		
		//勾选复选框，进行删除操作
		checkAllBox();
		delBtnClick("${ctx}/sys/yjmb/delete.ac?id=");
	});
//-->
</script>

	<form action="${ctx}/sys/yjmb/list.ac" method="post">
		<table style="width:100%">
			<tr>
				<td class="tbHeadLeft"></td>
				<td class="tbHeadTitle" id="headTitle">意见模板信息</td>
				...
				<td class="tbHeadBg" style="width: 79%;">
					 <div>
					   ...
					   <c:if test="${objectMap['XMSB_XT_YJMB_EDIT']}">
	...
	<table width="100%" border="0" cellpadding="1" cellspacing="0" bordercolor="AEC2D5" class="list">
		<thead>
			<tr>
				...
				<td width="30%">意见模板名称</td>
				<td width="45%">意见模板内容</td>
				<td width="15%">操作</td>
			</tr>
		</thead>
		<tbody>
			...
			<tr>
				<td>
					<input type="checkbox" value="${obj.yjmbId}" class="subcheck"/>
				</td>
				...
				<td>
					<c:if test="${objectMap['XMSB_XT_YJMB_EDIT']}">
					<a href="${ctx}/sys/yjmb/edit.ac?id=${obj.yjmbId}">编辑</a>
					&nbsp;&nbsp;|&nbsp;&nbsp;
					<a href="javascript:deleteAction('${ctx}/sys/yjmb/delete.ac?id=${obj.yjmbId}')">删除</a>
					</c:if>
				</td>
			</tr>
		</c:forEach>
