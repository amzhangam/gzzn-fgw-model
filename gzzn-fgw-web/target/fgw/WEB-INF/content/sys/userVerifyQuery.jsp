...
<body>
		...
		<div class="topSearchDiv" style="width: 100%;">
		  ...
		  <form action="./userVerifyQuery.ac" method="post">
		...
		<table style="width: 100%;margin: 0 auto;">
			<tr>
				...
				<td class="tbHeadTitle" id="headTitle" style="width:128px;">用户审核管理</td>
			...
			<tbody>
				...
				<%-- 	<td>
					...
					<td>
						...
						<a href="javascript:void(0)"  onclick="shenheUrl(<s:property value="userId"/>)">审核</a>
						</c:if>
					</td>
					</tr>
				</s:iterator>
