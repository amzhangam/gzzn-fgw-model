...
$(document).ready(function() {
	...
	//勾选复选框，进行删除操作
	checkAllBox();
	delBtnClick("${ctx}/buildImpl/delete.ac?params.stuType=1&id=");
});
</script>

	<form id="report" action="${ctx}/buildImpl/list.ac" method="post">
		<!-- 加载相关的查询条件 -->
		...
		<table style="width: 98%;margin: 0 auto;">
			<tr>
				...
				<td class="tbHeadTitle" id="headTitle" style="width:128px;">上报项目查询</td>
				...
				<tbody>
					<c:forEach items="${page.list}" var="obj" varStatus="status">
						<tr>
							...
							<td>
								<a href="javascript:deleteAction('${ctx}/buildImpl/delete.ac?params.stuType=1&id=${obj.bulidId}')">删除</a>
							</td>
						</tr>
					</c:forEach>
					<tr>
		...
		<%-- <table class="list" style="width: 98%;margin: 0 auto;">
			<thead> 
				<tr>
					...
					<td width="5%">区域</td>
					<td width="9%">所属单位</td>	
					<td width="9%">建设内容及规模</td>	
					<td width="7%">建设起止年限 </td>
					<td width="7%">总投资（万元）</td>	
					<td width="7%">到2013年底累计完成投资（万元）</td>	
					<td width="7%">2014年投资计划（万元）</td>	
					<td width="7%">2014年以来完成投资（万元）</td>	
					<!-- <td width="9%">立项批复文号</td>	 -->
					<td width="8%">项目类别</td>	
					<td width="5%">投资类型</td>	
					<td width="5%">项目联系人</td>	
					<td width="5%">联系电话</td>	
			...
			<tbody>
				<c:forEach items="${page.list}" var="obj" varStatus="status">
					<tr>
						...
						<td>${obj.sysOrganization.sysXq.xqmc}&nbsp;</td> 
						<td>${obj.sysOrganization.organizationName}&nbsp;</td> 
						<td title="${obj.projectcontent }">${Custom:subString(obj.projectcontent, 36, '...')}&nbsp;</td> 	
						<td>${obj.bulidQznx}&nbsp;</td> 	
						<td>${obj.pjinvestsum}&nbsp;</td> 	
						<td>${obj.expectfinishinvest}&nbsp;</td> 	
						<td>${obj.planinvestsum}&nbsp;</td> 	
				...
				<tr>
					<td colspan="15" class="line2"><%@include file="../changePage.jsp" %></td>
				</tr>
			</tbody>
		</table>	 --%>
	</form>
