...
function setXmcblb(ids){
	var url = "${ctx}/project/zdxm/xmcblb.json?id=" + ids + "&pageFlag=4";
	var w = 500;     //宽度
	 var h = 310;   //高度
...
/* 
	...
	<form id="report" action="${ctx}/report/zbxmk.ac" method="post">
		<!-- 加载相关的查询条件 -->
		<div class="topSearchDiv">
			<%-- <%@include file="../../report/reportQuery.jsp" %> --%>
			<%@include file="../pjplanreport/reportQuery.jsp" %>
		</div>
		<!-- 相关数据展示 -->	
		<table style="width:98%;margin: 0 auto;">
			<tr>
				<td class="tbHeadLeft"></td>
				<td class="tbHeadTitle" id="headTitle" style="width:128px;">预备项目库</td>
				<td class="tbHeadBg" style="width: 5%;"><div class="tbHeadMid"></div></td>
				<td class="tbHeadBg">
					 <div>
					   <span style="float: right;">     
					   		<c:if test="${objectMap['XMSB_XM_XMJHBBGL_EXP']}">
			            	<input type="button" class="btn" id="exportBtn" value="导出项目汇总表" onclick="exportexcel('${ctx}/report/expExcel.ac','tabList',3);"/>    
 		...
 		<div class="printDivStyle" id="exp">
			<table class="printTab" id="tabList">
				<thead> 
					<tr>
						<th width="2%" rowspan="2"><input type="checkbox" id="checkAll"></th>
				...
				<tbody>
					...
					<tr>
						<td colspan="11" class="line2" style="text-align: left;"><%@include file="../../changePage.jsp" %></td>
