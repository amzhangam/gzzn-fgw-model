...
function setXmcblb(ids){
	var url = "${ctx}/project/zdxm/xmcblb.json?id=" + ids + "&pageFlag=3";
	var w = 500;     //宽度
	 var h = 310;   //高度
...
/* 
	...
	<form id="report" action="${ctx}/report/zsxmk.ac" method="post">
		<!-- 加载相关的查询条件 -->
 		...
 		<div class="printDivStyle" id="exp">
			<table class="printTab" id="tabList">
				...
				<tbody>
					...
					<tr>
						<td colspan="26" class="line2"><%@include file="../../changePage.jsp" %></td>
