						...
						function() {
							if ($("#signupForm").valid()) {
								$("#signupForm")
										.ajaxSubmit(
												{
													url : '${ctx }/resource/ersEmrgTeamSave.json',
													type : "post",
													dataType : "json",
													success : function(data) {
														if (data.success) {
															parent.mac
																	.alert(data.info);
															window.location.href = "${ctx }/resource/ersEmrgTeamQuery.ac";
														} else {
															parent.mac
																	.alert(data.info);
														}
...
<body style="overflow: hidden">
	...
	<form action="${ctx }/resource/ersEmrgTeamSave.ac" method="post"
		id='signupForm'>
		...
		<table align="center" class="editTab" border="0" width="100%">
			<tbody>
				...
				<tr>
					<th>行政区划</th>
					<td colspan="3"><input id="districtName" name='dto.districtName'
				...
				<tr>
					<th>主管部门<span style="color: red">&nbsp;*</span></th>
					<td><input type="text" class="text" name="dto.supervisaldept"
						id='supervisaldept' value="${editObj.supervisaldept}" />
					</td>
					<th>唯一标识码<span style="color: red">&nbsp;*</span></th>
				...
				<tr>
					...
					<td colspan="3"><textarea name="dto.address" cols="100"
							rows="2" id='address'>${editObj.address}</textarea>
					</td>
				...
				<tr>
					<th>成立时间</th>
					<td colspan="3"><input type="text" name="dto.foundeddate" id='foundeddate'
						value="${editObj.foundeddate }"
				...
				<tr>
					<th>专长描述</th>
					<td colspan="3"><textarea cols="100" rows="3" id='skilled'
							name='dto.skilled'>${editObj.skilled }</textarea>
					</td>
				</tr>
				<tr style="display: none;">
					<th>救援队伍类型</th>
					<td><input name="dto.teamtype" id="teamtype" class="text"
						title="救援队伍类型" type="text" value='${editObj.teamtype}'>
					</td>
