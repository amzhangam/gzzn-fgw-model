...
$(document).ready(function() {
	...
	<form id="report" action="${ctx}/report/sqhzReport.ac" method="post">
		<!-- 加载相关的查询条件 -->
		...
		<table style="width:98%;margin: 0 auto;">
			<tr>
				...
				<td class="tbHeadTitle" id="headTitle" style="width:128px;">项目申请汇总报表</td>
 		...
 		<div class="printDivStyle" id="exp">
			<table class="printTab" id="tabList">
				...
				<tbody>
					...
					<tr>
						<td colspan="23" class="line2"><%@include file="../changePage.jsp" %></td>
						<!-- <td colspan="13" class="line2"></td>   -->      
					</tr>
				</tbody>
			</table>	
		</div>
