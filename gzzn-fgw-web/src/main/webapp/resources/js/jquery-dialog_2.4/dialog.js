...
mac.dialog = function(self, cfg) {
	...
	if (!cfg.noCloser) {
		var c = $('<span class="icon closer"></span>');
		c.hover(function() {
...
mac.wait = function(msg, params, w, h) {
	...
	dg.body.append('<div class="wait"><img src="'
			+ (App.contextPath ? App.contextPath : path)
			+ '/resources/images/bgWait.gif" align="center" /></div>');
	return dg;
}
