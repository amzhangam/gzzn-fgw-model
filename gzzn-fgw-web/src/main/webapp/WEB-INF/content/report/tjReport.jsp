...
$(document).ready(function() {
	...
	<form id="report" action="${ctx}/report/tjReport.ac" method="post">
		<!-- 加载相关的查询条件 -->
		...
		<table style="width:98%;margin: 0 auto;">
			<tr>
				...
				<td class="tbHeadTitle" id="headTitle" style="width:195px;">业主/主管单位提交项目计划报表</td>
