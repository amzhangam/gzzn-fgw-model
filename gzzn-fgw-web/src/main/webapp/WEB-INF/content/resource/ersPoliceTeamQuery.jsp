...
<SCRIPT LANGUAGE="JavaScript">
	...
	function infoToDelete(objTD) {
		...
		$.ajax({
			type : "POST",
			url : "${ctx }/resource/ersPoliceTeamDelete.json",
			data : {
				ids : objTD
			},
...
<body style="overflow: hidden">
	...
	<form action="${ctx }/resource/ersPoliceTeamQuery.ac" method="post">
		<table width="100%" border="0" cellpadding="0" cellspacing="0"
			...
			<tr>
				...
				<td width="154" class="c4">应急公安队伍</td>
				...
				<td width="80%" background="../resources/images/bg_k2.gif">
					<div align="right">
						...
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							<tr>
								<td width="66%" align="left"><strong>名称:</strong><input type="text"
									class="text" name="dto.teamname" value="${dto.teamname}"
									id="teamname" />&nbsp;<strong>类别名称:</strong>
								...
								<td>&nbsp;<input name="new4" type="submit" class="btn"
									value="查询"> &nbsp;<input name="new4" type="button"
									class="btn" value="新增"
									onClick="javascrip:window.location.href='ersPoliceTeamInit.ac'">
			...
			<tbody>
				<c:forEach items="${page.list}" var="obj" varStatus="status">
					<tr>
						...
						<td><a
							href='${ctx }/resource/ersPoliceTeamInit.ac?teamid=${obj.teamid}'
