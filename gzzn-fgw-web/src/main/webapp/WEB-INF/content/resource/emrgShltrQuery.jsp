...
<SCRIPT LANGUAGE="JavaScript">
	function infoToDelete(objTD) {
			...
			$.ajax({
		    	type:"POST",
		    	url:"${ctx }/resource/emrgShltrDelete.json",
		    	data:{ids:objTD},
...
<body style="overflow: hidden">
	<form action="${ctx }/resource/emrgShltrQuery.ac" method="post">
				...
				<td width="998" background="../resources/images/bg_k2.gif">
					<div align="right">
						...
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							<tr>
								<td width="76%"><strong>类别名称:</strong> <input type="hidden"
									...
									id="classifyName" /> 避难场所名称:<input
									type="text" name="sheltername" class="text" size="20"
									value='${param.sheltername }'> <input name="new4"
									type="button" class="btn" id='queryBtn' value="查询"> <input
									name="new4" type="button" class="btn" value="新增"
									onClick="javascrip:window.location.href='emrgShltrInit.ac'">&nbsp;<input
									type="button" value="批量删除" id="deleteBtn" class="btn">
								</td>
				...
				<c:forEach items="${page.list}" var="obj" varStatus="status">
					<tr>
						<td><input type="checkbox" name='checkedId'
							value='${obj.shelterid}' id='checkedId' /></td>
						<td>${status.count }</td>
						<td>${obj.sheltername }</td>
						...
						<td>${obj.capacity }</td>
						<td><a
							href='${ctx }/resource/emrgShltrInit.ac?shelterid=${obj.shelterid}'
							style="cursor: pointer; text-decoration: underline;">修改</a>&nbsp;&nbsp;||&nbsp;&nbsp;
							<a onclick="javascript:deleteOnClick(${obj.shelterid});"
