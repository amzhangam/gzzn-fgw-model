...
<SCRIPT LANGUAGE="JavaScript">
	...
	function infoToDelete(objTD) {
		$.ajax({
			type : "POST",
			url : "${ctx }/resource/ersCaseEeDelete.json",
			data : {
				ids : objTD
			},
...
<body style="overflow: hidden">
	...
	<form action="${ctx }/resource/ersCaseEeQuery.ac" method="post">
		<table width="100%" border="0" cellpadding="0" cellspacing="0"
			style="word-break: keep-all">
			<tr>
				<td width="13"><img src="../resources/images/k0.gif" width="13"
					height="37"></td>
				<td width="154" class="c4">案例衍生、次生信息</td>
				...
				<td width="79%" background="../resources/images/bg_k2.gif">
					<div align="right">
						...
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							<tr>
								<td width="66%" align="left"><strong>案例名称:</strong> <input type="text" name="dto.casename" id='casename'
									class="text" size="20"  value='${dto.casename }'>&nbsp;&nbsp;</td>
								<td>&nbsp;<input name="new4" type="button"   id='queryBtn'  class="btn"
									value="查询"> &nbsp;<input name="new4" type="button"
									class="btn" value="新增"
									onClick="javascrip:window.location.href='ersCaseEeInit.ac'">
		...
		<table class="list" onload="initView();iframeSelfAdapt();"
			...
			<tbody>
				<c:forEach items="${page.list}" var="obj" varStatus="status">
					...
					<tr>
						<td><input type="checkbox" name='checkedId' value='${obj.eeid}' id='checkedId'/></td>
						<td>${status.count }</td>
						<td>${obj.casename}</td>
						<td>${obj.eventtypecode}</td>
						<td>${obj.eventdesc }</td>
						<td><a
							href='${ctx }/resource/ersCaseEeInit.ac?eeid=${obj.eeid}'
							style="cursor: pointer; text-decoration: underline;">修改</a>&nbsp;&nbsp;||&nbsp;&nbsp;
							<a onclick="javascript:deleteOnClick(${obj.eeid});"
