...
//-->
	...
	<form action="${ctx}/project/zgdwshtgxm/list.ac" method="post"  enctype="multipart/form-data">
		...
		<table style="width:100%;height:300">
			<tr>
				...
				<td class="tbHeadTitle" id="headTitle">主管单位审核通过项目</td>
				<td class="tbHeadBg" style="width: 5%;"><div class="tbHeadMid"></div></td>
				<td class="tbHeadBg" style="width: 79%;height:300">
					<span style="float: right;">  
					  	<input type="button" class="btn" id="exportBtn" value="导出项目汇总表" onclick="exportexcel('${ctx}/project/zgdwshtgxm/expExcel.ac','tabList',2);"/>          
					</span>
				</td>
			...
			<tr>
				...
				<td>
					...
					%>
						...
						<a href="javascript:viewSh(${obj.projectid})">查看审核意见</a>
					</c:if>
					<%
						}
					%>
