...
//<!--
	   $(document).ready(function() {
			...
			$("#backBtn").click(function() {
				window.location = "${ctx}/sys/organization/listOwner.ac";
			});
...
<body>
	<form id="editForm" action="./saveOwnerVerify.ac"  method="post">
		...
		<table style="width:100%">
			<tr>
				<td align="center" style="width: 100%;">
						 ...
						 <input type="button" class="btn" value="返回"  onclick="backQuePage('./listOwnerVerify.ac')">
				</td>
			</tr>
		</table>
	</form>
