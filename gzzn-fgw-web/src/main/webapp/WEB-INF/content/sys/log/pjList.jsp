...
//<!--
	...
	$(document).ready(function() {
		...
		$("#printBtn").click(function(){
			...
			document.forms[0].action = "${ctx}/sys/log/printPj.json";
...
//-->
	...
	<form action="${ctx}/sys/log/pjList.ac" method="post">
		<!-- 加载相关的查询条件 -->
		<div class="topSearchDiv" style="width: 100%;">
			  <table class="topSearchTab">
				<tr>
					...
					<th>
						<c:if test="${objectMap['XMSB_XT_RZGL_XMRZ_VIEW']}">
		...
		<table style="width:100%">
			<tr>
				...
				<td class="tbHeadTitle" id="headTitle">项目日志</td>
				<td class="tbHeadBg" style="width: 5%;"><div class="tbHeadMid"></div></td>
				<td class="tbHeadBg" style="width: 79%;">
					 <div>
					    <span style="float: right;">     
			            	 <!-- <input type="button" class="btn" id="printBtn" value="打印"/> -->
			            	 <input type="button" class="btn" id="expBtn" value="导出" onclick="exportexcel('${ctx}/sys/log/exportExcelPJ.ac','tabList');"/>     
		               	</span>     
		             </div>
				</td>
