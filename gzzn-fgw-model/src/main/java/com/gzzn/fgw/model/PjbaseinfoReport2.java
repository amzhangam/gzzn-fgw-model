...
/**
 * PjbaseinfoReport2 entity. @author MyEclipse Persistence Tools
 */
@Entity
@Table(name="PJBASEINFO_REPORT2"
    
)

public class PjbaseinfoReport2  implements java.io.Serializable {


    // Fields    

     private PjbaseinfoReport2Id id;


    // Constructors

    /** default constructor */
    public PjbaseinfoReport2() {
    }

    
    /** full constructor */
    public PjbaseinfoReport2(PjbaseinfoReport2Id id) {
        this.id = id;
    }
    ...
    @AttributeOverrides( {
        @AttributeOverride(name="numberid", column=@Column(name="NUMBERID", length=20) ), 
    ...
    public PjbaseinfoReport2Id getId() {
        return this.id;
    }
    
    public void setId(PjbaseinfoReport2Id id) {
        this.id = id;
    }
