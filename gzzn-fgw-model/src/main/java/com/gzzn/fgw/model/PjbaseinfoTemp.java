...
/**
 * PjbaseinfoTemp entity. @author MyEclipse Persistence Tools
 */
@Entity
@Table(name="PJBASEINFO_TEMP"
    
)

public class PjbaseinfoTemp  implements java.io.Serializable {


    // Fields    

     private PjbaseinfoTempId id;


    // Constructors

    /** default constructor */
    public PjbaseinfoTemp() {
    }

    
    /** full constructor */
    public PjbaseinfoTemp(PjbaseinfoTempId id) {
        this.id = id;
    }
    ...
    public PjbaseinfoTempId getId() {
        return this.id;
    }
    
    public void setId(PjbaseinfoTempId id) {
        this.id = id;
    }
