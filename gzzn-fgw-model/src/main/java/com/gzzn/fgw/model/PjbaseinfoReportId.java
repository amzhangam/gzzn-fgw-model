...
/**
 * PjbaseinfoReportId entity. @author MyEclipse Persistence Tools
 */
@Embeddable

public class PjbaseinfoReportId  implements java.io.Serializable {
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof PjbaseinfoReportId) ) return false;
		 PjbaseinfoReportId castOther = ( PjbaseinfoReportId ) other; 
