...
/**
 * PjbaseinfoTempId entity. @author MyEclipse Persistence Tools
 */
@Embeddable

public class PjbaseinfoTempId  implements java.io.Serializable {
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof PjbaseinfoTempId) ) return false;
		 PjbaseinfoTempId castOther = ( PjbaseinfoTempId ) other; 
         
		 return ( (this.getProjecttype()==castOther.getProjecttype()) || ( this.getProjecttype()!=null && castOther.getProjecttype()!=null && this.getProjecttype().equals(castOther.getProjecttype()) ) )
